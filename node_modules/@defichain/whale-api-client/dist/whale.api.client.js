...
const consortium_1 = require("./api/consortium");
const whale_api_response_1 = require("./whale.api.response");
const errors_1 = require("./errors");
const governance_1 = require("./api/governance");
/**
...
class WhaleApiClient {
    constructor(options) {
        ...
        this.consortium = new consortium_1.Consortium(this);
        this.governance = new governance_1.Governance(this);
        this.options = Object.assign(Object.assign({}, DEFAULT_OPTIONS), options);
        this.options.url = (_a = this.options.url) === null || _a === void 0 ? void 0 : _a.replace(/\/$/, '');
    }
    /**
     ...
     */
    requestList(method, path, size, next, queryParam) {
        return __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=whale.api.client.js.map