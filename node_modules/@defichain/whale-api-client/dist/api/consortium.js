...
class Consortium {
    ...
    getAssetBreakdown() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.requestData('GET', 'consortium/assetbreakdown');
        });
    }
    /**
    ...
    getMemberStats(memberid) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.requestData('GET', `consortium/stats/${memberid}`);
        });
    }
}
