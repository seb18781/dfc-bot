...
export declare class WhaleApiClient {
    ...
    readonly fee: Fee;
    readonly loan: Loan;
    readonly consortium: Consortium;
     ...
     */
    requestList<T>(method: Method, path: string, size: number, next?: string, queryParam?: QueryParameter): Promise<ApiPagedResponse<T>>;
    /**
     * @param {'POST|'GET'} method to request
     * @param {string} path to request
...
//# sourceMappingURL=whale.api.client.d.ts.map