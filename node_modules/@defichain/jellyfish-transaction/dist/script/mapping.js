...
exports.OP_CODES = {
    ...
    OP_DEFI_TX_TOKEN_BURN: (tokenBurn) => {
        return new dftx_1.OP_DEFI_TX({
            signature: dftx_2.CDfTx.SIGNATURE,
            type: dftx_token_1.CTokenBurn.OP_CODE,
            name: dftx_token_1.CTokenBurn.OP_NAME,
            data: tokenBurn
        });
    },
    ...
    OP_DEFI_TX_UPDATE_MASTER_NODE: (updateMasternode) => {
        return new dftx_1.OP_DEFI_TX({
            signature: dftx_2.CDfTx.SIGNATURE,
            type: dftx_masternode_1.CUpdateMasternode.OP_CODE,
            name: dftx_masternode_1.CUpdateMasternode.OP_NAME,
