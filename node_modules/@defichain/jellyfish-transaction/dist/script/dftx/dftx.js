...
class CDfTx extends jellyfish_buffer_1.ComposableBuffer {
    ...
    static data(dftx) {
        ...
        switch (dftx.type) {
            ...
            case dftx_token_1.CTokenBurn.OP_CODE:
                return compose(dftx_token_1.CTokenBurn.OP_NAME, d => new dftx_token_1.CTokenBurn(d));
            ...
            case dftx_masternode_1.CUpdateMasternode.OP_CODE:
                return compose(dftx_masternode_1.CUpdateMasternode.OP_NAME, d => new dftx_masternode_1.CUpdateMasternode(d));
