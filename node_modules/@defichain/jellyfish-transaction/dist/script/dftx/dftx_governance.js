...
class CCreateProposal extends jellyfish_buffer_1.ComposableBuffer {
    composers(ccp) {
        return [
            ...
            jellyfish_buffer_1.ComposableBuffer.satoshiAsBigNumber(() => ccp.nAmount, v => ccp.nAmount = v),
            jellyfish_buffer_1.ComposableBuffer.uInt8(() => ccp.nCycles, v => ccp.nCycles = v),
            jellyfish_buffer_1.ComposableBuffer.compactSizeUtf8BE(() => ccp.title, v => ccp.title = v),
            jellyfish_buffer_1.ComposableBuffer.compactSizeUtf8BE(() => ccp.context, v => ccp.context = v),
            jellyfish_buffer_1.ComposableBuffer.compactSizeUtf8BE(() => ccp.contexthash, v => ccp.contexthash = v),
            jellyfish_buffer_1.ComposableBuffer.uInt8(() => ccp.options, v => ccp.options = v)
        ];
    }
}
