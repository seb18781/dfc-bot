...
exports.CTokenBurn = exports.CTokenUpdateAny = exports.CTokenUpdate = exports.CTokenCreate = exports.CTokenMint = void 0;
...
class CTokenMint extends jellyfish_buffer_1.ComposableBuffer {
    composers(tm) {
        return [
            ...
            jellyfish_buffer_1.ComposableBuffer.single(() => tm.to, v => tm.to = v, v => new tx_composer_1.CScript(v))
        ];
    }
}
 ...
 * Immutable by design, bi-directional fromBuffer, toBuffer deep composer.
 */
class CVariantScript extends jellyfish_buffer_1.ComposableBuffer {
    composers(tb) {
        return [
            jellyfish_buffer_1.ComposableBuffer.uInt32(() => tb.variant, v => tb.variant = v),
            jellyfish_buffer_1.ComposableBuffer.single(() => tb.context, v => tb.context = v, v => new tx_composer_1.CScript(v))
        ];
    }
}
/**
 ...
 * Immutable by design, bi-directional fromBuffer, toBuffer deep composer.
 */
class CTokenBurn extends jellyfish_buffer_1.ComposableBuffer {
    composers(tb) {
        return [
            jellyfish_buffer_1.ComposableBuffer.compactSizeArray(() => tb.amounts, v => tb.amounts = v, v => new dftx_balance_1.CTokenBalance(v)),
            jellyfish_buffer_1.ComposableBuffer.single(() => tb.from, v => tb.from = v, v => new tx_composer_1.CScript(v)),
            jellyfish_buffer_1.ComposableBuffer.uInt8(() => tb.burnType, v => tb.burnType = v),
            jellyfish_buffer_1.ComposableBuffer.single(() => tb.variantContext, v => tb.variantContext = v, v => new CVariantScript(v))
        ];
    }
}
exports.CTokenBurn = CTokenBurn;
CTokenBurn.OP_CODE = 0x46; // 'F'
CTokenBurn.OP_NAME = 'OP_DEFI_TX_TOKEN_BURN';
