...
const txn_builder_vault_1 = require("./txn/txn_builder_vault");
const txn_builder_token_1 = require("./txn/txn_builder_token");
...
__exportStar(require("./txn/txn_builder_vault"), exports);
...
__exportStar(require("./txn/txn_builder_token"), exports);
/**
...
class P2WPKHTransactionBuilder extends txn_builder_1.P2WPKHTxnBuilder {
    constructor() {
        ...
        this.vault = new txn_builder_vault_1.TxnBuilderVault(this.feeProvider, this.prevoutProvider, this.ellipticPairProvider, this.network);
        this.tokens = new txn_builder_token_1.TxnBuilderTokens(this.feeProvider, this.prevoutProvider, this.ellipticPairProvider, this.network);
    }
}
