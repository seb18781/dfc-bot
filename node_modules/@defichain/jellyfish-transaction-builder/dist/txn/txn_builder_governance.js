...
class TxnBuilderGovernance extends txn_builder_1.P2WPKHTxnBuilder {
    ...
    createCfp(createCfp, changeScript) {
        return __awaiter(this, void 0, void 0, function* () {
            if (createCfp.nCycles > 100) {
                throw new txn_builder_error_1.TxnBuilderError(txn_builder_error_1.TxnBuilderErrorType.INVALID_CFP_CYCLE, 'CreateCfp cycles should be between 0 and 100');
            }
            const creationFee = bignumber_js_1.default.maximum(10, createCfp.nAmount.multipliedBy(0.01));
    ...
    createVoc(createVoc, changeScript) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!createVoc.nAmount.isEqualTo(new bignumber_js_1.default(0))) {
            ...
            let creationFee = new bignumber_js_1.default('5');
            if (this.network.name === 'mainnet') {
                creationFee = new bignumber_js_1.default('100');
            }
            if (this.network.name === 'testnet') {
                creationFee = new bignumber_js_1.default('50');
            }
            if (createVoc.options === 1) {
                creationFee = new bignumber_js_1.default('10000');
            }
