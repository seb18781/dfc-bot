...
class Masternode {
     ...
     */
    updateMasternode(masternodeId, values, utxos = []) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('updatemasternode', [masternodeId, values, utxos], 'number');
        });
    }
    /**
     ...
     *
     */
    unsetGov(variables, utxos = []) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('unsetgov', [variables, utxos], 'number');
        });
    }
    /**
    ...
    clearMempool() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('clearmempool', [], 'number');
        });
    }
}
