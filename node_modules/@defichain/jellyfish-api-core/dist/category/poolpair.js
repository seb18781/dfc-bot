...
class PoolPair {
     ...
     * @return {Promise<string>}
     */
    updatePoolPair(metadata, utxos = []) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('updatepoolpair', [metadata, utxos], 'number');
        });
    }
    /**
    ...
    testPoolSwap(metadata, path = 'auto', verbose = false) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('testpoolswap', [metadata, path, verbose], 'bignumber');
        });
    }
    /**
