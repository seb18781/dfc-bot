...
(function (DfTxType) {
    ...
    DfTxType["NONE"] = "0";
    DfTxType["FUTURE_SWAP_EXECUTION"] = "q";
    DfTxType["FUTURE_SWAP_REFUND"] = "w";
...
class Account {
     ...
     * @return {Promise<string>}
     */
    futureSwap(future, utxos = []) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('futureswap', [future.address, future.amount, future.destination, utxos], 'number');
        });
    }
    /**
     ...
     * @return {Promise<string>}
     */
    withdrawFutureSwap(future, utxos = []) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('withdrawfutureswap', [future.address, future.amount, future.destination, utxos], 'number');
        });
    }
    /**
    ...
    getPendingFutureSwaps(address) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('getpendingfutureswaps', [address], 'number');
        });
    }
    /**
    ...
    listPendingFutureSwaps() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('listpendingfutureswaps', [], 'number');
        });
    }
    /**
    ...
    listPendingDusdSwaps() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('listpendingdusdswaps', [], 'bignumber');
        });
    }
    /**
    ...
    getPendingDusdSwaps(address) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('getpendingdusdswaps', [address], 'bignumber');
        });
    }
}
