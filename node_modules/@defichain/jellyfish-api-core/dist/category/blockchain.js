...
class Blockchain {
    ...
    getTxOutSetInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('gettxoutsetinfo', [], {
    ...
    getMempoolAncestors(txId, verbose = false) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('getmempoolancestors', [txId, verbose], 'bignumber');
        });
    }
    /**
    ...
    getMempoolDescendants(txId, verbose = false) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('getmempooldescendants', [txId, verbose], 'bignumber');
        });
    }
    /**
    ...
    getMempoolEntry(txId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('getmempoolentry', [txId], 'bignumber');
        });
    }
    /**
     ...
     * @return Promise<WaitBlockResult> the current block on timeout or exit
     */
    waitForBlock(blockhash, timeout = 30000) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('waitforblock', [blockhash, timeout], 'number');
        });
    }
    /**
