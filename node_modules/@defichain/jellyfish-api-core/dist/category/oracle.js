...
class Oracle {
     ...
     */
    listPrices(startIndex, includingStart, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('listprices', [{ start: startIndex, including_start: includingStart, limit }], 'bignumber');
        });
    }
    /**
    ...
    getFutureSwapBlock() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.call('getfutureswapblock', [], 'number');
        });
    }
}
